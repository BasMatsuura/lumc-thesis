...
# Load data set
data <- readRDS("/home/basmatsuura/Desktop/v2_thesis/R-Markdown/GibbsINLA_2/simulation/models_1/gaussian_I-2/a2_simulation.rds")
...
ggsave("a2_matching_percentage_plot.png", plot = p, width = 8, height = 8)
